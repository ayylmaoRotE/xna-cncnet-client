...
{
    public class CampaignSelectorROTE : XNAWindow
    {
        ...
        public CampaignSelectorROTE(WindowManager windowManager, DiscordHandler discordHandler) : base(windowManager)
        {
        ...
        public override void Initialize()
        {
            ...
            ParseBattleIni("INI\\BattleROTE.ini");
