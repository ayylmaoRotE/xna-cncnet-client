...
{
    public class CampaignSelectorCHL : XNAWindow
    {
        ...
        public CampaignSelectorCHL(WindowManager windowManager, DiscordHandler discordHandler) : base(windowManager)
        {
        ...
        public override void Initialize()
        {
            ...
            ParseBattleIni("INI\\Challenge.ini");
