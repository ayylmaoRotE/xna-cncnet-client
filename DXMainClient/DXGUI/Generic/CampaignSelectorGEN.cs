...
{
    public class CampaignSelectorGEN : XNAWindow
    {
        ...
        public CampaignSelectorGEN(WindowManager windowManager, DiscordHandler discordHandler) : base(windowManager)
        {
        ...
        public override void Initialize()
        {
            ...
            ParseBattleIni("INI\\BattleGEN.ini");
